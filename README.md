...
Conformer with multi-scale local attention and *(periodic positional encoding) for composer classification. See [coma-gen](https://github.com/imbulana/coma-gen) for a similar architecture used for music generation.
